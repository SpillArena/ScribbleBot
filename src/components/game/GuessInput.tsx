...
import { getProximity } from "../../lib/similarity";
...
export default function GuessInput() {
    ...
    const submit = () => {
        ...
        const proximity = getProximity(trimmed, currentWord);
        const correct = proximity === "correct";

        addGuess({ text: trimmed, correct, proximity, timestamp: Date.now() });
        setValue("");
